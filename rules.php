...
<section id="privacy">
        <div class="container">
            ...
            <div class="content">
                <h1>ELIGIBILITY</h1>
                <p>Prior to the Competition Period, you may request to enter the Competition and become an entrant if (a) you are a legal resident of the 50 United States and the District of Columbia and are twenty-one (21) years of age or older and (b) you visit the Sponsor’s website at www.gelbergroup.com/thebreakout (the “Application Website”), complete all fields in the application found on the Application Website (the “Application”), and provide all information requested by Sponsor in connection with the Application (each of such persons, an “Applicant”).<br/> <br/>

Prior to the Competition Period, Sponsor will select certain of the Applicants to participate in the Competition based on such Applicants’ Applications and such other information and factors as Sponsor may determine in its sole and absolute discretion. Applicants who are selected by the Sponsor to be eligible to participate in the Competition (the “Accepted Applicants”) will be notified by Sponsor at least two (2) weeks prior to the Competition Period. After the Accepted Applicants have been notified by Sponsor pursuant to the immediately preceding sentence, each Accepted Applicant shall be required to attend one or more training sessions related to the Platform, as determined by Sponsor in its sole and absolute discretion (collectively, the “Training”). <p class="bold"> All Applicants who are not Accepted Applicants or who are Accepted Applicants who do not complete the Training shall not be entitled to participate in the Competition or become an entrant to the Competition. </p> <br/>

You need not be present to win. Employees (and their immediate families or those living in the same household) of the Sponsor and its respective affiliates, subsidiaries, divisions, parent and related companies, suppliers, printers and advertising, promotional and judging agencies (including the Committee) are not eligible to enter or win. Individuals who appear on the U.S. Government Department of Treasury’s Specially Designated Nations List are also not eligible to enter or win. <br/> <br/>

An “entrant” is an Accepted Applicant who completes the Training prior to the Competition Period and submits an entry (together with all related Competition Materials) in accordance with these Official Rules. <br/> <br/>
...
In order to submit an entry to the Competition, each entrant must complete all of the following tasks and deliver to Sponsor the following materials (collectively with all other materials, data, information, and writings required by these Official Rules or requested by Sponsor, the “Competition Materials”):
                    ...
                    <li class="margin-bottom">Each entrant must consummate trades during the Competition Period in certain futures contracts and/or foreign exchange (“FX”) cash markets, each of which may be limited by Sponsor as set forth on the Platform (each, an “Eligible Trading Instrument”).                     </li>
                    ...
                    <li class="margin-bottom">Each entrant must prepare and submit a daily trading recap to Sponsor on the Platform on each business day of the Competition Period including the information required by Sponsor for such recaps as set forth on the Platform (which, for clarification, shall constitute Competition Materials).                    </li> </br> 
                    
                    <p>If trades entered by an entrant are not in compliance with these Official Rules, then such trades will be rejected on the Platform. In addition, unusually high numbers of trades or other problematic activities in an Account may lead to a suspension of such Account. <br/> </br> 

A particular entrant’s placement during the Competition Period and at the end of the Competition (i.e., the last day of the Competition) is determined based on the realized profits and losses on such entrants’ Account. Realized profits and losses for the purposes of the Competition and determining the Winners are the profits and losses realized on closed positions as set forth in the particular Account. All open positions in each Account must be closed out by the entrants by no later than 3:00 p.m. CT on October 31, 2024. Failure to close out open positions in an Account by such time will result in disqualification of the entrant. <br/>

All entries must be received by 12:59 p.m. CST on August 30, 2024. Illegible, incomplete and duplicate entries will be disqualified. No responsibility is assumed by the Sponsor(s) for any inability of a potential entrant to successfully enter the Competition for any reason. <br/>  </br> 

If it is discovered that an entrant has registered or attempted to enter more than once using multiple Accounts, e-mail addresses, telephone numbers, multiple identities, IP addresses, use of proxy servers or any other method of unauthorized entry, all in Sponsor’s sole and absolute discretion, all of that entrant’s entries will be declared null and void, entrant will be disqualified from the Competition and any Prize that entrant might have been entitled to receive will not be awarded to him/her. Entries that are late, lost, illegible, duplicated, mechanically reproduced, contain false information, damaged, misdirected, mutilated, garbled or incomplete, altered or otherwise irregular in the sole discretion of Sponsor, that have been submitted or generated using robotic, programmed, script, or any other automated means, or illicit means, or do not conform with or satisfy any or all of the conditions set out in the Official Rules, as determined by Sponsor in its sole and absolute discretion, may be judged void and disqualified. <br/> <br/>

<p class="bold"> Each entrant may only submit one (1) entry to the Competition and, therefore, may only enter the Competition one (1) time. </p> <br/> <br/>

<p class="bold"> Any entry (or any Competition Materials provided in connection with an entry) that violates any of these Official Rules will not be eligible for the Competition. </p>
...
Each entrant understands and agrees that these materials, including any Competition Materials, shall become the sole property of Sponsor and may not be returned. 
    ...
    <table class="prize-table">
        ...
        <tr>
            <td class="bold">Grand Prize</td>
            <td>One (1)</td>
            <td>$20,000</td>
            <td>$20,000</td>
        </tr>
        <tr>
        <td class="bold">Second Place Prize</td>
            <td>One (1)</td>
            <td>$10,000</td>
            <td>$10,000</td>
        </tr>
        <tr>
        <td class="bold">Third Place Prize</td>
            <td>One (1)</td>
            <td>$50,000</td>
            <td>$50,000</td>
        </tr>
...
<li> <p class="bold">Acceptance of the Prize constitutes permission by the Winners to the Sponsor and its agencies to use the Winner’s entry and Competition Materials for purposes of advertising and trade without further compensation, in perpetuity and in any and all media now known or hereafter discovered, unless prohibited by law. </p>
</li><br/> 
...
<div class="content">
    ...
    <p>By participating in the Competition, each entrant consents to Sponsor’s or authorized agents’ collection, use, and disclosure of entrant’s personal information for the purposes of administering and promoting the Competition and Prize fulfillment. Each entrant acknowledges that he/she has read, understood and accepted the applicable Sponsor’s Privacy Policy, which provides more information about Sponsor’s privacy practices and is located at <a href="https://www.gelbergroup.com/gelber-privacy-notice/" target="_blank"> https://www.gelbergroup.com/gelber-privacy-notice</a> (the “Privacy Policy”). <br/> <br/>
...
Entrants may be offered the optional opportunity to receive coupons, newsletters, informational materials, marketing communications, or other special promotions, or other offers from Sponsor, affiliates within the Sponsor groups, and/or third-party service providers. Entrants will not be contacted for marketing purposes unless they have provided their express consent. <br/> <br/>


<p class="bold">By accepting the Prize, and unless prohibited by law, each Winner agrees to Sponsor’s use of Winner’s entry and Competition Materials, his/her name, city/province of residence, picture, biographical information, statements, voice and likeness in any advertising and publicity Sponsor and its/their respective successors, assigns and licensees may conduct relating to the Competition in any media or format, whether now known or hereafter developed, including but not limited to the internet, at any time or times in perpetuity, without further compensation or notice, and hereby releases Released Parties from any liability with respect thereto.</p>
</p>
</div>
...
<div class="content">
            ...
            <p class="font-size-larger bold"> SPONSOR RESERVES THE RIGHT TO AMEND THE ABOVE RULES AT ANY TIME. <br/> <br/>

THIS COMPETITION IS VOID WHERE PROHIBITED OR RESTRICTED BY LAW OR WHERE BONDING, REGISTRATION, OR OTHER REQUIREMENTS WOULD BE REQUIRED BUT HAVE NOT BEEN MET.<br/> <br/>
...
<section id="miniFooter">
        <div class="container">
            ...
            <div class="content">
                <p class="margin-none">Gelber Group is happy to announce THE BREAKOUT – a fully remote, discretionary, simulated Futures & FX trading competition that will take  place this September/October 2024</p>
                <p class="margin-none">Abbreviated Rules</p>
            </div>
